...
public class Login extends javax.swing.JFrame {
    ...
    public void validarUsuario() {
        ...
        if (usuario.equals("") && contraseña.equals("")) {
            ...
            try {
                String sql = "select cedula,nombre,apellido,cargo,contrasenia from usuarios where cedula='" + usuario + "'";
                ...
                if (rs.next()) {
                    ...
                    String d = rs.getString("contrasenia");
                    String s = rs.getString("cargo");
